...
struct GuideComponent_Previews: PreviewProvider {
    static var previews: some View {
        GuideComponent(title: "title", subtitle: "swipe right", description: "this is a placeholder sentence this is a placeholder sentence this is a placeholder sentence", icon: "heart.circle").previewLayout(.sizeThatFits)
    }
}
